                            ...
                            <nav class="navbar navbar-expand-lg navbar-light">
                                ...
                                <div class="navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav m-auto">
                                        <li class="nav-item">
                                            <a href="{{ url('workspace/1') }}" class="nav-link">
                                                <span><b>Co Working Space</b></span>
                                            </a>

                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ url('workspace/7') }}" class="nav-link">
                                                <span><b>Meeting Room</b></span>
                                            </a>

                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ url('workspace/8') }}" class="nav-link">
                                                <span><b>Business Center</b></span>
                                            </a>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu animated">
                                                <a class="dropdown-item active" href="{{ url('about') }}">About</a>
                                                <a class="dropdown-item active" href="{{ url('pricing') }}">Pricing</a>
                                                <a class="dropdown-item" href="{{ url('faq') }}">FAQ</a>
                                                <a class="dropdown-item" href="{{ url('terms-condition') }}">Terms & Conditions</a>
