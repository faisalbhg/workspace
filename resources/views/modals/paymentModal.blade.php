                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-container">
                        <div class="field-container">
                            ...
                            <input id="name" wire:model="card_name" maxlength="20" type="text">
                        </div>
                        <div class="field-container">
                            <label for="cardnumber">Card Number</label><!-- <span id="generatecard">generate random</span> -->
                            <input id="cardnumber" type="text" pattern="[0-9]*" wire:model="card_number" inputmode="numeric">
                        ...
                        <div class="field-container">
                            ...
                            <input id="expirationdate" type="text" pattern="[0-9]*" wire:model="card_exp_month_year" inputmode="numeric">
                        </div>
                        <div class="field-container">
                            <label for="securitycode">Security Code</label>
                            <input id="securitycode" type="text" pattern="[0-9]*" wire:model="card_cvv" inputmode="numeric">
                        </div>
                        <div class="btn btn-primary d-block h8" wire:click="saveSubmitPayNow">PAY <span class=" ms-2">{{config('global.CURRENCY')}}</span>{{$tempSubscriptions->grand_total}}<span class="ms-3 fas fa-arrow-right"></span></div>
...
<script type="text/javascript">
    window.addEventListener('cardPaymentPannel',event=>{
