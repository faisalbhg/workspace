...
class CoWorkingSpace extends Component
{
    ...
    public function render()
    {
        ...
        $data['workspaces'] = $workspaceUnitsQuery->where(['is_active'=>1,'workspace_category'=>3])->orderBy('display_order','ASC')->paginate(10);
        $this->dispatchBrowserEvent('listenMap',['locations'=>$this->locations]);

        return view('livewire.co-working-space', $data);
    }
}
